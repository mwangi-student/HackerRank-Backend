...
def get_all_mcq_submissions():
    ...
    return jsonify([
        {"id": sub.id, "submission_id": sub.submission_id, "question_id": sub.question_id, "selected_answer": sub.selected_answer}
...
def get_mcq_submission(submission_id):
    ...
    return jsonify({"id": submission.id, "submission_id": submission.submission_id, "question_id": submission.question_id, "selected_answer": submission.selected_answer})
